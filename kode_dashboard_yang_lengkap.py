# -*- coding: utf-8 -*-
"""Copy of Kode Dashboard yang Lengkap.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1FmkJUqR6gXDQgeW_3Vuy3oj97kuWbbfH

# **📊 Data Understanding: E-Commerce Customer Behavior**
...
"""## **Tampilan Singkat Data (Data Preview)**"""
...
# Melihat (jumlah baris, jumlah kolom)
dimensi = df.shape
print(f"Jumlah Baris (Transaksi): {dimensi[0]} baris")
print(f"Jumlah Kolom (Variabel): {dimensi[1]} kolom")

"""## **Pemeriksaan Tipe Data (Data Info)**"""

# Menampilkan informasi detail tentang tipe data tiap kolom
df.info()
...
# Hanya menampilkan kolom yang memiliki data kosong (jika ada)
print("Jumlah Missing Values per kolom:")
print(data_kosong[data_kosong > 0] if data_kosong.any() else "Data bersih, tidak ada missing values!")

"""## **Pengecekan Duplikasi Data**"""

# Menghitung total baris yang duplikat
jumlah_duplikat = df.duplicated().sum()
print(f"Ditemukan sebanyak {jumlah_duplikat} baris data yang duplikat.")

"""## **Ringkasan Statistik Dasar (Descriptive Statistics)**"""

# Menampilkan ringkasan metrik statistik (mean, min, max, quartil)
# Membatasi tampilan 2 angka di belakang koma agar rapi
df.describe().round(2)

"""## **Eksplorasi Nilai Unik (Kolom Kategori)**"""

# Kolom kategori utama yang akan kita cek
kolom_kategori = ["Gender", "City", "Product_Category", "Device_Type", "Payment_Method"]
